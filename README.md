...
# how to play
* go to the [itch.io page](https://herbeon.itch.io/silly-pfp-maker-demo), download and run the executable! (requires linux, but no python/pygame required!)
* randomize a pfp
...
# no linux?
* if you have python and pygame installed, you can clone this repo and run main.py
